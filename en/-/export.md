...
<!-- Source: blog/git-submodule-input.md -->
<!-- URL: https://nixos.asia/en/blog/git-submodule-input -->
<!-- Title: Git Submodules as Nix Flake Inputs -->
<!-- Wikilinks: [[blog/git-submodule-input]], [[git-submodule-input]] -->
...
Install #[[nix]] using [the experimental installer][ei]:[^official]

[ei]: https://github.com/NixOS/experimental-nix-installer
